						...
						<div class="wrap-address-billing">
							...
							<div class="billing-address">
								<p class="row-in-form">
									...
									<input type="text" name="fname" value="" placeholder="Name" wire:model="firstname">
								...
								<p class="row-in-form">
									...
									<input type="text" name="phone" value="" placeholder="Phone Number" wire:model="mobile">
								...
								<p class="row-in-form">
									...
									<input type="text" name="zip-code" value="" placeholder="Zip Code" wire:model="zipcode">
						...
						<div class="wrap-address-billing">
							...
							<div class="billing-address">
								...
								<p class="row-in-form">
									...
									<input type="email" name="email" value="" placeholder="Email Address" wire:model="s_email">
									@error('s_email') <span class="text-danger">{{$message}}</span> @enderror
								</p>
								<p class="row-in-form">
									<label for="phone">Phone number<span>*</span></label>
									<input type="text" name="phone" value="" placeholder="Phone Number" wire:model="s_mobile">
								...
								<p class="row-in-form">
									<label for="city">Town / City<span>*</span></label>
									<input type="text" name="city" value="" placeholder="City" wire:model="s_city">
									@error('s_city') <span class="text-danger">{{$message}}</span> @enderror
								</p>

								<p class="row-in-form">
									<label for="zip-code">Zip Code</label>
									<input type="number" name="zip-code" value="" placeholder="Zip Code" wire:model="s_zipcode">
